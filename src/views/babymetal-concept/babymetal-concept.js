...
import { IMAGES, BABYMETAL_IMAGES } from '../../images.js';
        ...
        return (
            <div className={'viewContainer'}>
                ...
                <div className={'workPageContainer'}>
                    ...
                    <Gallery 
                        images={[
                            <Thumbnail style='large' key={getUniqueKey()} image={BABYMETAL_IMAGES.FrontPageDesktop_Babymetal} onClick={() => this.pickLightBoxImage(0)}/>,
                            ...
                            <Thumbnail style='small' key={getUniqueKey()} image={BABYMETAL_IMAGES.FrontPageMobile_Babymetal} onClick={() => this.pickLightBoxImage(2)}/>,
                            <Thumbnail style='small' key={getUniqueKey()} image={BABYMETAL_IMAGES.FrontPageMobileMenuOpen_Babymetal} onClick={() => this.pickLightBoxImage(3)}/>
                        ]}
                    />
                    <div>
                ...
                <div className={'workPageContainer'}>
                    ...
                    <Gallery 
                        images={[
                            <Thumbnail style='large' key={getUniqueKey()} image={BABYMETAL_IMAGES.BioDesktop_Babymetal} onClick={() => this.pickLightBoxImage(4)}/>,
                ...
                <div className={'workPageContainer'}>
                    ...
                    <Gallery 
                        images={[
                            <Thumbnail style='large' key={getUniqueKey()} image={BABYMETAL_IMAGES.BandMemberDesktop_Babymetal} onClick={() => this.pickLightBoxImage(7)}/>,
                ...
                <div className={'workPageContainer'}>
                    ...
                    <Gallery 
                        images={[
                            <Thumbnail style='large' key={getUniqueKey()} image={BABYMETAL_IMAGES.DiscogDesktop_Babymetal} onClick={() => this.pickLightBoxImage(10)}/>,
                ...
                <div className={'workPageContainer'}>
                    ...
                    <Gallery 
                        images={[
                            <Thumbnail style='large' key={getUniqueKey()} image={BABYMETAL_IMAGES.TourDesktop_Babymetal} onClick={() => this.pickLightBoxImage(13)}/>,
